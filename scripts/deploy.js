...
async function main() {
  ...
  if (data.DynastyFactory && data.WDNY) {
    await deploy('DynastyRouter', [data.DynastyFactory, data.WDNY])
  } else {
    throw 'data.DynastyFactory and data.WDNY are expected to be available'
  }
}
